...
export default function returnWeekday(day: number, month: number, year: number): DateResponse {
  ...
  switch (calenderTypeInteger) {
    case 0: //Fictive
      console.log("Fictive calender type running");
